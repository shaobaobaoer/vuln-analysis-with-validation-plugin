...
- If a finding includes template-engine `rce` metadata, the report must surface the engine, template control mode, sandbox mode, and payload family in the finding narrative
